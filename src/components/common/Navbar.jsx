          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            {user ? (
              ...
              <>
                ...
                <Link
                  to="/register"
                  className="bg-gradient-to-r from-orange-500 to-red-500 text-white font-semibold px-5 py-2 rounded-full text-sm transition-all hover:shadow-lg hover:shadow-orange-500/30 hover:scale-105"
                >
                  Sign Up
                </Link>
              </>
          ...
          <div className="md:hidden glass-dark rounded-2xl mt-2 p-4">
            {navLinks.map((link) => (
              <Link
                ...
                className={`block px-4 py-3 text-sm font-medium rounded-xl mb-1 transition-all ${
                  isActive(link.path)
              ...
              {user ? (
                ...
                <div className="flex gap-3">
                  <Link
                    to="/login"
                    onClick={() => setMenuOpen(false)}
                    className="border border-white/20 text-white text-sm py-2 rounded-full flex-1 text-center hover:border-orange-500"
                  >
                    Login
                  </Link>
                  ...
                  <Link
                    to="/register"
                    onClick={() => setMenuOpen(false)}
                    className="bg-gradient-to-r from-orange-500 to-red-500 text-white text-sm py-2 rounded-full flex-1 text-center"
                  >
                    Sign Up
                  </Link>
                </div>
