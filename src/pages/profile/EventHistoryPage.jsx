          ...
          {eventOrders.map((item) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 self-end sm:self-center">
                <span
                  className={`font-medium px-3 py-1 rounded-full text-sm border ${
                ...
                {item.status !== "Cancelled" && (
                  <button
                    ...
                    className="bg-red-500 hover:bg-red-600 text-white font-medium text-sm px-4 py-2 rounded-lg transition"
                  >
                    Cancel Booking
                  </button>
                )}
