...
const ForgotPasswordPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Network/server errors only (4xx with a real message)
      const msg =
          ...
          {!sent ? (
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full bg-white/5 border rounded-xl pl-11 pr-4 py-3 text-white text-sm placeholder-white/20 outline-none transition-all ${
                        error
            ...
            <div className="text-center py-4">
              ...
              <p className="text-white/40 text-sm mb-1">
                If that email is registered, we've sent a reset link to
              </p>
